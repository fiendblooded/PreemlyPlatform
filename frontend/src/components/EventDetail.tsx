...
const EventDetail: React.FC = () => {
  ...
  // const generateQrCodeBase64 = async (content: string): Promise<string> => {
  //   try {
  //     // Options to reduce QR code size
  //     const options = {
  //       width: 150, // Reduce the width/height of the QR code
  //       margin: 1, // Reduce margin to make the image smaller
  //       color: {
  ...
  //     return base64; // Returns the QR code as a base64 string
  //   } catch (error) {
